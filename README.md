...
[^pandoc]: Changing the README is automatically caused by rebranding, as the name is changed in the README, so `make rebrand <new-name>` will need `pandoc`. Find moore information in the *Rebranding* section.
